...
```{r}
#| echo: false
readxl::read_excel(here::here("pans-report", "year1", "pans-table1.xlsx")) %>% 
  dplyr::mutate(`Socio-demographic characteristic` = tidyr::replace_na(`Socio-demographic characteristic`, "")) %>% 
  knitr::kable()
```
